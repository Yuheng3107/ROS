...
class ArmJointState(genpy.Message):
  _md5sum = "079088df50b5c07b4d8a3c78bb761a44"
...
int16 position7
"""
  __slots__ = ['position1','position2','position3','position4','position5','position6','position7']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_7h().pack(_x.position1, _x.position2, _x.position3, _x.position4, _x.position5, _x.position6, _x.position7))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.position1, _x.position2, _x.position3, _x.position4, _x.position5, _x.position6, _x.position7,) = _get_struct_7h().unpack(str[start:end])
      return self
